...
from chemicalc.s2n import Sig2NoiseWMKO, Sig2NoiseHectoBinoSpec, Sig2NoiseVLT, Sig2NoiseMSE
...
class InstConfig:
    ...
    def set_snr(self, snr_input: Union[int, float, np.ndarray, Sig2NoiseWMKO, Sig2NoiseVLT, Sig2NoiseHectoBinoSpec, Sig2NoiseMSE]) -> None:
        """
        ...
        elif isinstance(snr_input, (Sig2NoiseWMKO, Sig2NoiseVLT, Sig2NoiseHectoBinoSpec, Sig2NoiseMSE)):
